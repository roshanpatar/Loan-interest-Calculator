...
class LoanCalculator:
    ...
    def __init__(self):
        ...
        Label(window, text = "Total interest").grid(row = 6,
                                      column = 1, sticky = W)
        ...
        lblTotalInterest = Label(window, textvariable =self.totalInterestVar).grid(row = 6,column = 2, sticky = E)
    ...
    def computePayment(self):
        ...
        totalInterest = float(self.totalPaymentVar.get())- int(self.loanAmountVar.get())

        self.totalInterestVar.set(format(totalInterest, '10.2f'))
...
#Calculating Total Interest
    def getTotalInterest(self, loanAmount,totalPayment):
